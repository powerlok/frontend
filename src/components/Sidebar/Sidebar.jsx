  ...
  render() { 
    ...
    var user = (
      <div className={userWrapperClass}> 
        <div className={photo}>
          <img src={(authentication.user.fotos) ? authentication.user.fotos :  avatar } className={classes.avatarImg} alt="..." />
        </div>
        <List className={classes.list}>
          <ListItem className={classes.item + ' ' + classes.userItem}>
            ...
            >
              <ListItemText
                primary={rtlActive ? '' : (authentication) ? authentication.user.nome : 'Não localizado'}
                secondary={
                  <b
                    className={
                      caret +
              ...
              <List className={classes.list + ' ' + classes.collapseList}>
                ...
                {/* <ListItem className={classes.collapseItem}>
                  ...
                  >
                    ...
                    <ListItemText
                      primary={rtlActive ? '' : 'Configurações'}
                      disableTypography={true}
                      className={collapseItemText}
                    />
                  </NavLink>
